...
class Contact extends Component {
    ...
    handleInputChange(event){
        ...
        const name = target.name; //name of properties in state should be same as name of element
                            ...
                            <FormGroup row>
                                <Label htmlFor="lastname" md={2}>Last Name</Label>
                                    <Col md={10}>
                                        ...
                                        invalid={errors.lastname !== ''} onBlur={this.handleBlur('lastname')} onChange={this.handleInputChange} />
                            ...
                            <FormGroup row>
                                <Label htmlFor="email" md={2}>Email</Label>
                                    <Col md={10}>
                                        ...
                                        invalid={errors.email !== ''} onBlur={this.handleBlur('email')} onChange={this.handleInputChange} />
